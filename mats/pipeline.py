...
class DataPipeline:
    ...
    def preprocess_data(self):
        ...
        # TODO: interpolate missing values in met_df. og fjerne de radene uten data
        # - find time in energy_df that is not in met_df
        # - find values that are missing under 12 hours consecutively
